...
public:
    ...
    void appendNode(Node* n)
    {
        ...
        {
            cout<<"Node Already exists with the key value: "<<n->key<<". Append another node with the different key value"<<endl;
        }
        else
        {
            if(head == NULL)
    ...
    void insertNodeAfter(int k,Node* n)
    {
        ...
        else
        {
            if(nodeExists(n->key)!= NULL)
            {
                cout<<"Node already exists with the key value : "<<n->key<<". Append another node with a different key value."<<endl;
            }
            else
            {
                cout<<"INSERTING"<<endl;
